function [GeIm] = drawrearwall(EstimatedVertex,rough_coefficient,OrIm)
...
%% rear wall (y:1~7, x:1~2)
    % vertices 1,2,7,8
    worldVertex(3,:) = EstimatedVertex(5,2); % Vertices of the mesh on the same plane (Z = -1);
    ...
    for k = EstimatedVertex(4,2):rough_coefficient:EstimatedVertex(4,8) % from y1 to y7
        ...
        worldVertex(2,[3,4]) = k + rough_coefficient; % y coordinate of 3. and 4. should be k + Coeff. (8,7)
